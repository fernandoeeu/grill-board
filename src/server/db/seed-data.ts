  ...
  questions: [
    {
      ...
      recommendation:
        'Sim — nenhuma branch nova, nenhum merge novo, zero conflito/rebase novo.',
      answer:
        'Sim, ambiente sem branch — git flow intocado (feature branch de main, 1 PR).',
      answeredVia: 'chat',
    },
    {
      id: 'q7',
      ...
      answer:
        'Só previews — nenhum staging fixo; prod promovido de main como hoje.',
      answeredVia: 'chat',
    },
    {
      id: 'q2',
