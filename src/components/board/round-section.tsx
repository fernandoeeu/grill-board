  ...
  return (
    <section
      ...
      className={cn(
        ...
        isConfirmation &&
          "-mx-4 rounded-2xl bg-accent-50/60 p-4 ring-1 ring-accent-200 sm:-mx-5 sm:p-5",
      )}
    >
      <div className="flex items-baseline gap-3">
        ...
        >
          {isConfirmation ? `Confirmation — Round ${round.number}` : `Round ${round.number}`}
        ...
        <div
          className={cn("h-px min-w-0 grow", isConfirmation ? "bg-accent-200" : "bg-stone-100")}
        />
      </div>
