  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-6 pt-24 pb-40">
      ...
      <p className="mt-2 max-w-xl text-sm leading-relaxed text-stone-500">
        A topic is one interrogation: rounds of questions grouped by category, each with
        the agent&rsquo;s recommendation and your answer. Choose one in the sidebar, or
        start a new one.
      </p>
      ...
      <div className="mt-12 border-t border-stone-100 pt-6">
        ...
        <p className="mt-2 max-w-xl text-sm leading-relaxed text-stone-500">
          Register this board as an MCP server and an agent can create topics, fire
          rounds of questions and read your answers back.
        </p>
