 ...
 */
export function groupByRound(questions: Question[], rounds: Round[]): RoundSectionData[] {
  ...
  const declared = [...rounds]
    ...
    .filter((section) => section.questions.length > 0 || section.round.kind === "confirmation");
